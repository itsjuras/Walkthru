  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-6">
      <div className="w-full max-w-md bg-gray-900 rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-white mb-6">Log in to PropertyMapper</h2>
        ...
        <p className="text-gray-400 text-sm mt-4 text-center">
          No account? <Link to="/signup" className="text-blue-400 hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  )
